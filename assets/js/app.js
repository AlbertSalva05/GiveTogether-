  ...
  views.start = function () {
    return {
      ...
      html: '<div class="container">' +
        ...
        '<p class="section"><a class="btn btn--primary btn--lg" href="index.html#demo">Book a walkthrough</a> <a class="btn btn--secondary btn--lg" href="index.html#pricing">See pricing</a></p>' +
        '</div>'
    };
  };
  ...
  $(function () {
    ...
    $.ajax({ url: CONFIG.dataUrl, dataType: 'json', cache: true, timeout: 10000 })
      .done(function (payload) {
        ...
        state.campaigns = $.map(payload && payload.campaigns || [], sanitizeCampaign);
        state.bySlug = {};
        $.each(state.campaigns, function (_, c) { state.bySlug[c.slug] = c; });
        render();
      })
      .fail(function () {
